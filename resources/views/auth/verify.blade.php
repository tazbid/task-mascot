...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="{{url('/')}}"><b>Verification Code</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">An unique verification code has been sent to your email.</p>
                ...
                <form id="verifyForm">
                    ...
                    <div class="input-group mb-3">
                        <input type="number" id="code" name="code" class="form-control" placeholder="Verification Code" required>
                ...
                $.ajax({
                    ...
                    error: function (jqXHR, exception) {
                        ...
                        if (jqXHR.status === 0) {
                            ...
                            msg = 'Invalid verification code. [403]';
                            toastr.warning(
                                msg,
                                'Error!', {
                                    timeOut: 5000,
                            ...
                            $("#verify-errors").append(errorMarkup);
                            //errorStyleInit();
